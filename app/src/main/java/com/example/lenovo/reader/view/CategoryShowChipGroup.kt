 ...
 */
class CategoryShowChipGroup : ChipGroup {
...
//    }
  ...
  private fun createActionChipFromCategory(category: Category): Chip {
    return (LayoutInflater.from(context).inflate(
      R.layout.chip_action_icon, this, false
    ) as Chip).apply {
      chipIcon = context.getDrawable(R.drawable.ic_edit_white_24dp)
  ...
  private fun createFilterChipFromCategory(category: Category): Chip {
    return (LayoutInflater.from(context).inflate(
      R.layout.chip_category_show, this, false
    ) as Chip).apply {
      text = category.name
